...
#     def getcount(self, sequence, maxwcnt):
#         sentcnt = 0
#         wcnt = 0
#         for sent in sequence:
#             wcnt += len(sent.sentence.words)
#             if wcnt >= 1.1 * maxwcnt:
#                 break
#             sentcnt += 1
#         return sentcnt
...
#                 return sequence[:self.getcount(sequence, count)]
#             else:
#                 return sequence[:self.getcount(sequence, int(self._value))]
