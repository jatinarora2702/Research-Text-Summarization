...
tf.app.flags.DEFINE_integer('num_epochs', 10, 'No of epochs to train')
tf.app.flags.DEFINE_integer('attn_heads', 5, "No of attention heads")
tf.app.flags.DEFINE_integer('min_input_len', 1, "")
tf.app.flags.DEFINE_integer('sent_embed_dimensions', 300, 'No of embedding dimensions of sentence')
...
def main(unused_argv):
  vocab = data.Vocab(FLAGS.vocab_path, 30000)
  ...
  hps = seq2seq_attention_model.HParams(
      ...
      sent_embed_dimensions=FLAGS.sent_embed_dimensions)  
